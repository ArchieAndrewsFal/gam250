public static class LineUpSqlSettings
{
    ...
    public static string getDataByCountPhp = "185.52.2.95/GetDataByCount.php";     //Store the location of the get data by count php script on the sql server
    public static string getDataByDate = "";
}
